...
description: "Example ingestion skill that reads raw transcript files and produces entity-linked meeting files. Triggers: 'process transcripts', 'ingest meetings'. Produces: wiki/meetings/YYYY/MM/ files with frontmatter."
version: "1.0.0"
created: 2026-01-10
updated: 2026-01-15
category: processing
...
4. Write entity-linked meeting file to `wiki/meetings/YYYY/MM/`
5. Never modify raw source files

## Output Format

Each output file includes frontmatter with `type: meeting-transcript`, `source: granola`, entity wikilinks, and the full transcript content in the body.
